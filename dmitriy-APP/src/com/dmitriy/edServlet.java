...
public class edServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter out = response.getWriter()) {
			...
			int i = Integer.parseInt(request.getParameter("num0"));
			String username1 = request.getParameter("num1");
			String note = request.getParameter("num2");
			...
			try {
				...
				session.createQuery("update users set username = '" + username1 + "',  note = '" + note + "', "
						+ "first_name = '" + firstname1 + "', last_name = '" + lastname1 + "' where user_id = " + i)
						.executeUpdate();
							  ...
							  "<div class='row'>" +
							   "<div class='col-sm-12'>" +
							      "<div class='card-body p-3'>" +
							        "<h1 class='text-center text-uppercase text-success success'>success!<br><br>Note was updated </h1>" +
							      "</div>" +
							    "</div>" +
							  "</div>" +
							"</div>"
